...
console.log('***** routes speech_to_text.js exports *****');

console.log('***** routes speech_to_text.js  *****' + process.env.SPEECH_TO_TEXT_USERNAME);
console.log('***** routes speech_to_text.js  *****' + process.env.SPEECH_TO_TEXT_PASSWORD);
