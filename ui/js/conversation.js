...
var Conversation = (function() {
  ...
  function init() {
    console.log('***** Conversation.js init() *****');
    chatSetup();
    initEnterSubmit();
    setupInputBox();
  }
  ...
  function chatSetup() {
    ...
    console.log('***** Conversation.js chatSetup() *****');
  ...
  function initEnterSubmit() {
    console.log('***** Conversation.js initEnterSubmit() *****');
  ...
  function displayMessage(newPayload, typeValue) {
    console.log('***** Conversation.js displayMessage() *****');
  ...
  function buildMessageDomElement(newPayload, isUser) {
            console.log('***** Conversation.js buildMessageDomElement() *****');
    var dataObj = isUser ? newPayload.input : newPayload.output;
    var messageJson = {
      ...
      'children': [{
        ...
        'html': (isUser ? '<img src=\'/images/head.svg\' />' + dataObj.text : '<img src=\'/images/head.svg\' />' + dataObj.text)
      }]
    };
  ...
  function updateChat() {
        console.log('***** Conversation.js updateChat() *****');
